...
# root = /home/hh/v2i/data/image/2_persecond/
# listfile = /home/ai/ssd/caffe/data/Inspur/trainval.txt
# outdir = /home/data/Inspur/lmdb/Inspur_trainval_lmdb
# exampledir = examples/Inspur
...
if __name__ == "__main__":
  ...
  if anno_type == "detection":
    cmd = "{}/build/tools/convert_annoset_inspur" \
        " --anno_type={}" \
        " --label_type={}" \
        " --label_map_file={}" \
        " --check_label={}" \
    ...
    # cmd = /home/ai/ssd/caffe/build/tools/convert_annoset
    # --anno_type=detection
    # --label_type=xml
    ...
    # out_dir = /home/ai/data/Inspur/lmdb/Inspur_trainval_lmdb
